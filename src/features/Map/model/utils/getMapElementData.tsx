const getMapElementsData = (mapElement: HTMLElement, popupElement: HTMLElement, markerElement: HTMLElement) => {
    ...
    const bottomSpace = mapElementData.top + mapElementData.height - markerElementData.top - markerHeight
    ...
    const rightSpace = mapElementData.left + mapElementData.width - markerElementData.left - markerWidth
    ...
    const leftC = mapElementData.left + mapHalfWidth - markerElementData.left + markerHalfWidth / 2 - popupHalfWidth / 2
    const bottomC = markerElementData.top - mapElementData.top + markerHeight - mapHalfHeight - popupHalfHeight
