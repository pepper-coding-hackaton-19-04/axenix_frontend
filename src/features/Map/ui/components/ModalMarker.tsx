...
import { ReactifyApi } from '@/global/providers/Ymap/model/types/YMapSchema'
import { YMap } from '@yandex/ymaps3-types'
import React, { memo, useCallback, useEffect, useRef, useState } from 'react'
import { Place } from '../../model/types/Place'
import getPopupPosition from '../../model/utils/getPopupPosition'
...
interface MarkerWithPopupProps {
    ...
    selectPlace: ActionCreatorWithPayload<string | null, 'map/selectPlace'>
}

export const MarkerWithPopup = ({ mapRef, place, selected, reactifyApi, selectPlace }: MarkerWithPopupProps) => {
    ...
    return (
        <YMapMarker key={place.id} zIndex={selected ? 10 : 1} coordinates={[place.longitude, place.latitude]}>
            <div onMouseEnter={() => selectPlace(place.id)} onMouseLeave={() => selectPlace(null)}>
                <div
                    ref={markerRef}
