import getMapElementsData from './getMapElementData'

const getPopupPosition = (mapElement: HTMLElement, popupElement: HTMLElement, markerElement: HTMLElement) => {
    const {
        markerHeight,
        spaceAvailableAtTop,
    ...
    if ((spaceAvailableAtLeft || spaceAvailableAtRight) && (spaceAvailableAtTopY || spaceAvailableAtBottomY)) {
